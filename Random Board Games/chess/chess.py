...
starting_order = {(0, 0): pygame.image.load(br.image), (1, 0): pygame.image.load(bkn.image),
                  (2, 0): pygame.image.load(bb.image), (4, 0): pygame.image.load(bk.image),
                  (3, 0): pygame.image.load(bq.image), (5, 0): pygame.image.load(bb.image),
                  ...
                  (2, 7): pygame.image.load(wb.image), (4, 7): pygame.image.load(wk.image),
                  (3, 7): pygame.image.load(wq.image), (5, 7): pygame.image.load(wb.image),
